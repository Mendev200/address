...
import { putUpdateContact } from "../components/api/putUpdateContact";
...
function UpdateContact() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await putUpdateContact(formData);
    ...
    if (redirect) {
        return <Navigate to="/home" />; // Utilise Navigate pour rediriger vers "/home" après une mise à jour réussie
    }
